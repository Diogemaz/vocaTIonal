...
?>
    ...
    <body id="page-top">
                ...
                <div class="row align-items-center justify-content-center mb-5">
                    ...
                    ?>
                        <div class="card borda animated fadeInRight" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $curso->getNome(); ?></h5>
                                <p class="card-text link-card">
                                    Preço: <?php if ($curso->getPreco() == 0.00) {
                                                echo "Gratuito";
                                            } else {
                                                echo str_replace(".", ",", $curso->getPreco());
                                            } ?>
                                    </a>
        ...
        <section class="bg-primary2" id="avaliacao">
            <div class="container">
                <div class="d-flex justify-content-center">
                    <?php if (isset($_SESSION['user'])) { ?>
                        <button style="border: 0; background: transparent" onclick="like()">
                            <img id="like" src="<?php if ($profissao->getAvaliacao() == 1) {
                                                    echo "../assets/img/like_sel.png";
                                                } else {
                                                    echo "../assets/img/like.png";
                                                } ?>" height="40px" width="40px">
                        </button>
                        <button style="border: 0; background: transparent" onclick="deslike()">
                            <img id="deslike" class="mt-3 rotate" src="<?php if ($profissao->getAvaliacao() == -1) {
                                                                            echo "../assets/img/like_sel.png";
                                                                        } else {
                                                                            echo "../assets/img/like.png";
                                                                        } ?>" height="40px" width="40px">
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-4">
                        <div class="progress">
                            <div class="progress-bar" style="width: <?php if ($profissao->getProcAvaliacao() == -1) {
                                                                        echo 0;
                                                                    } else {
                                                                        echo $profissao->getProcAvaliacao();
                                                                    } ?>%" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="text-center text-white"><?php if ($profissao->getProcAvaliacao() == -1) {
                                                        echo "Profissão não avaliada";
                                                    } else {
                                                        echo number_format($profissao->getProcAvaliacao(), 2, ",", "") . "%";
                                                    } ?></div>
                    </div>
                </div>
            </div>
        ...
        <!--Área de comentario-->
        <section class="bg-primary3" id="comentarios">
