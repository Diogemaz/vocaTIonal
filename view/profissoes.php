...
<body id="page-top">
    ...
    <section class="bg-primary" id="opcoes">
        <div class="container animated fadeIn">
            ...
            <div class="row justify-content-center" id="escolha-trilhas" style="display:none;" >
            <?php 
                $AsTrilhas = array();
                $nomeTrilha = array();
                $cont = 0;
    ...
    <!-- trilas-->
    <section class="page-section bg-primary" id="services-trilhas"
    ...
    <section class="page-section bg-primary" id="services-profissoes" style="position: relative; z-index: 0;">
        ...
        <div class="row justify-content-center">
            ...
            <form id="form-favorita" onsubmit="favorita();" method="POST" action="../controller/favoritaArea.php">
                <input type="text" style="display: none;" id="user"
                    value="<?php if(isset($user)){ echo $user->getId();} ?>">
                <button type="submit" class="btn btn-light btn-xl js-scroll-trigger animated fadeInDown" id="favoritar"
                    name="favoritar"><?php 
            ...
            <?php }else{ ?>
            <button type="button" class="btn btn-light btn-xl js-scroll-trigger" onclick="favoritaSemUser();"
                name="favoritar">Favoritar área</button>
            <?php } ?>
        </div>
    </section>
        ...
        <div class="container">
            <div class="d-flex justify-content-center">
                ...
                <button style="border: 0; background: transparent" onclick="like()">
                    <img id="like"
                        src="<?php if($area->getAvaliacao() == 1){ echo "../assets/img/like_sel.png"; }else{ echo "../assets/img/like.png"; } ?>"
                        height="40px" width="40px">
                </button>
                <button style="border: 0; background: transparent" onclick="deslike()">
                    <img id="deslike" class="mt-3 rotate"
                        src="<?php if($area->getAvaliacao() == -1){ echo "../assets/img/like_sel.png"; }else{ echo "../assets/img/like.png"; } ?>"
                        height="40px" width="40px">
                </button>
                <?php }else{ ?>
                ...
                <div class="col-4">
                    <div class="progress">
                        <div class="progress-bar"
                            style="width: <?php if($area->getProcAvaliacao() == -1){ echo 0; }else{echo $area->getProcAvaliacao();} ?>%"
                            role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="text-center text-white">
                        <?php if($area->getProcAvaliacao() == -1){echo "Área não avaliada";}else{echo number_format($area->getProcAvaliacao(), 2, ",", "") . "%";} ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-2">
            <form id="comentar" onsubmit="comentar();" method="POST">
                <div class="form-group">
                    ...
                    <textarea class="form-control" required id="comentario" data-ls-module="charCounter"
                        oninput="if(this.scrollHeight > this.offsetHeight) this.rows += 1" maxlength="500"
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <button class="dropdown-item"
                                            onclick="excluirComentario(<?php echo $comentario['id_comentarioArea']; ?>);">Excluir</button>
                                    </div>
                                </li>
                            </ul>
                        </div>
