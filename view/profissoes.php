            ...
            <div class="container mt-2">
                <form id="comentar" onsubmit="comentar();" method="POST">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" required id="comentario" data-ls-module="charCounter" oninput="if(this.scrollHeight > this.offsetHeight) this.rows += 1" maxlength="500" name="comentario" rows="1">
                        </textarea>
                    </div>
