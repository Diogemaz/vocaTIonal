                ...
                <div class="page-wrapper">
                    ...
                    <div class="page-breadcrumb">
                        <div class="row">
                            <div class="col-12 d-flex no-block align-items-center">
                                <select id="areaSelect" name="areaSelect" onchange="trilhas(this.value)">
                    ...
                    <div class="container-fluid">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="nome" name="nome" maxlength="35" placeholder="Nome da trilha." required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                        ...
                        <?php } else {
                            ...
                            $trilhas->consultarTrilha($_GET['trilha']);
                            $_SESSION['trilhas'] = serialize($trilhas);
                        ?>
                            <div class="container-fluid">
                                <form class="form-horizontal" id="form-trilha-at" action="" method="POST">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="nome" class="col-sm-3 text-end control-label col-form-label">Nome:</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" id="nome" name="nome" maxlength="35" placeholder="Nome da trilha." value="<?php echo $trilhas->getNome(); ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="area" class="col-sm-3 text-end control-label col-form-label">Área:</label>
                                                ...
                                                <div class="border-top">
                                                    <div class="card-body">
                                                        <button type="button" onclick="alterarTrilha();" class="btn btn-primary">Alterar</button>
                                                        <button type="button" onclick="deletarTrilha();" class="btn btn-primary">Excluir</button>
                                                        <button type="button" class="btn btn-primary"><a href="adm-profissao.php" style="text-decoration: none; color: white;">Adicionar nova</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="pontos" class="row justify-content-center mb-5">
                                            <?php
                                            $textos = explode("|", $trilhas->getTexto());
                                            $count = 0;
                                            foreach ($textos as $pontos) {
                                            ?>
                                                <button type="button" class="circulo" id="botao-seletor" onclick="EscolheItem('<?php echo $count + 1; ?>')"><?php echo $count + 1; ?></button>
                                            <?php $count++;
                                            } ?>
                                        </div>
                                        ...
                                        <div class="row justify-content-center" id="texto-pontos">
                                            ...
                                            foreach ($textos as $pontos) {
                                            ?>
                                                <div class="form-group row" id="edit-ponto">
                                                    <label for="texto" class="col-sm-12 text-center control-label col-form-label">
                                                        Texto <?php echo $count + 1; ?>
                                                        <button type="button" class="close" id="excluir-ponto">
